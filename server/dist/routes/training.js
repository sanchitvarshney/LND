...
router.post('/assignments', (0, auth_js_1.requireRole)('manager'), async (req, res) => {
    ...
    await db_js_1.prisma.notification.create({ data: { userId: p.data.userId, type: 'assignment', title: 'New training assigned', body: 'You have a new training module to complete.' } });
