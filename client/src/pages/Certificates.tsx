...
export default function Certificates() {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-2xl font-display font-bold text-slate-900">My Certificates</h1><p className="text-slate-500 text-sm mt-0.5">Your earned training certifications.</p></div>
