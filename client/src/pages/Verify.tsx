  ...
  return (
    <div className="min-h-screen grid place-items-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="flex items-center justify-center gap-2 mb-6"><div className="h-9 w-9 rounded-xl text-white grid place-items-center shadow-glow" style={{ background: 'linear-gradient(135deg,#04b0a8,#017b75)' }}><GraduationCap size={20} /></div><span className="font-display font-bold text-xl text-slate-900">LearnGuard</span></div>
        <div className="card p-8 text-center">
          {isLoading ? <Spinner /> : (error || !data?.valid) ? (
            <>
              ...
              <h1 className="text-xl font-display font-bold text-slate-900 mt-4">Certificate {data?.status || 'not found'}</h1>
            ...
            <>
              ...
              <h1 className="text-xl font-display font-bold text-slate-900 mt-4">Verified authentic</h1>
