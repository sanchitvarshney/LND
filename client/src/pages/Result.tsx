...
export default function Result() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5">
      <div className={`card p-8 text-center ${passed ? 'ring-2 ring-emerald-200' : ''}`}>
        ...
        <h1 className="text-2xl font-extrabold text-slate-900 mt-4">{passed ? 'Congratulations — you passed!' : 'Not quite there yet'}</h1>
